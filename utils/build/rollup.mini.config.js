...
function addons() {
	...
	return {
		...
		transform(code, id) {
			...
			code = code.replace('build/mini/coool-three.module.js', 'src/Three.Mini.js');
...
let builds = [
	{
		...
		output: [
			{
				format: 'esm',
				file: 'build/mini/coool-three.module.js'
			}
		]
	},
	{
		...
		output: [
			{
				format: 'umd',
				name: 'THREE',
				file: 'build/mini/coool-three.js',
				indent: '\t'
			}
		]
	},
		...
		output: [
			{
				format: 'umd',
				name: 'THREE',
				file: 'build/mini/coool-three.min.js'
			}
		]
	}
];
